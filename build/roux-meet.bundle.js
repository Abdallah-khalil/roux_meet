...
const speakersRoute_1 = __webpack_require__(10);
const feedbackRouter_1 = __webpack_require__(11);
const apiRouter_1 = __webpack_require__(12);
const chatRouter_1 = __webpack_require__(15);
const dataFile = __webpack_require__(16);
class App {
    constructor() {
    ...
    routes() {
        ...
        this.expressApp.use('/Chat', chatRouter_1.default);
    }
    ;
}
...
const dataFile = __webpack_require__(14);
class ApiRouter {
    constructor() {
        this.router = express_1.Router();
        this.init();
